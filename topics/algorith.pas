...
{---------------------------------------------------------------------------}
{  WARNING : Ch��ng tr�nh ch� ch�y ���c khi c� t�p tin SVGA256.BGI ���c     }
{  n�p v�o b� nh�. N�u b�n kh�ng c� t�p tin n�y, xin b�n h�y vui l�ng li�n  }
{  h� v�i t�c gi� �� copy n�. Xin ch�n th�nh c�m �n s� �ng h� qu� b�u c�a   }
{  c�c b�n. M�i th�c m�t hay � ki�n ��ng g�p xin li�n h� v� ��a ch� sau :   }
{       Address  : B�n V�n ��n Ph��ng 1 Qu�n 4                              }
...
PROCEDURE RunChar1;
CONST St = '<< Tr��ng ��i H�c K� Thu�t C�ng Ngh� TP. H� Ch� Minh'+
...
PROCEDURE RunChar2;
CONST St ='<< Ch��ng Tr�nh Ki�m Tra C�c Thu�t To�n ��n Gi�n Version 2.0'+
      ' (c) Copyright By Student Nguy�n Ng�c V�n All Rights Reserved >>';
  BEGIN
    TextBackGround(DarkGray);
    REPEAT
      RunChar(St)
           ...
           BEGIN
             IF b=0 THEN
               BEGIN
                 ...
                 WriteXY(28,11,'Ph��ng tr�nh c� nghi�m');
                 WriteXY(30,12,'v�i m�i X thu�c R')
               END
             ELSE
               BEGIN
                 Clear(27,9,55,16,Blue);
                 ...
                 SetTextColor(Yellow,Magenta);
                 WriteXY(28,12,'Ph��ng tr�nh v� nghi�m')
               END
           END
       END;
...
BEGIN   { Bat dau Module_1 }
  REPEAT
    ...
    WriteXY(29,11,'- Nh�p h� s� A = ');
    Readln(a);
    WriteXY(29,12,'- Nh�p h� s� B = ');
    Readln(b);
    Equation_First(a,b);
    SetTextColor(Yellow,Blue);
  ...
  VAR Delta : Real;
    ...
    VAR Ngiem_kep :Real;
      BEGIN
        ...
        SayXY(37,9,White,Green,'Result');
        SetTextColor(Yellow,Magenta);
        WriteXY(29,11,'Ph��ng tr�nh c� nghi�m k�p');
        WriteXY(31,12,'* X=');
        GotoXY(35,12);
        Write(Ngiem_Kep:0:2)
      END;
    ...
    PROCEDURE Delta_Am;
      BEGIN
        ...
        SayXY(37,9,White,Green,'Result');
        SayXY(36,11,LightCyan+Blink,Magenta,'WARNING!');
        SayXY(29,12,Yellow,Magenta,'Ph��ng tr�nh v� nghi�m')
      END;
    ...
    VAR X1,X2 :Real;
      BEGIN
        ...
        SayXY(37,9,White,Green,'Result');
        SetTextColor(Yellow,Magenta);
        WriteXY(29,11,'Ph��ng tr�nh c� hai nghi�m');
        WriteXY(31,12,'* X1=');
        WriteXY(31,13,'* X2=');
        GotoXY(36,12);
        Write(X1:0:2);
...
BEGIN { Bat dau Module_3 }
  REPEAT
    ...
    SayXY(18,3,LightCyan,Brown,
          'Ch��ng Tr�nh Gi�i H� Ph��ng Tr�nh Tuy�n T�nh');
    BoxShade(27,9,54,18,Cyan,Yellow,2);
    SayXY(35,9,White,Red,'Input Data');
    SetTextColor(Black,Cyan);
    WriteXY(29,11,'- Nh�p h� s� A1 = ');
    Readln(a1);
    WriteXY(29,12,'- Nh�p h� s� B1 = ');
    Readln(b1);
    WriteXY(29,13,'- Nh�p h� s� C1 = ');
    Readln(c1);
    WriteXY(29,14,'- Nh�p h� s� A2 = ');
    Readln(a2);
    WriteXY(29,15,'- Nh�p h� s� B2 = ');
    Readln(b2);
    WriteXY(29,16,'- Nh�p h� s� C2 = ');
    Readln(c2);
    SetTextColor(Yellow,Blue);
    DD:=a1*b2-a2*b1;
    Dx:=b1*c2-b2*c1;
      ...
      BEGIN
        IF (Dx = 0) AND (Dy = 0) THEN
          BEGIN
            ...
            SayXY(37,9,White,Green,'Result');
            SayXY(36,11,LightCyan+Blink,Magenta,'WARNING!');
            SayXY(30,12,Yellow,Magenta,'*** H� V� ��nh ***');
            SetTextColor(Yellow,Blue);
        ...
        ELSE
          BEGIN
            ...
            SayXY(31,12,Yellow,Magenta,'*** H� V� Nghi�m ***');
            SetTextColor(Yellow,Blue);
            WriteXY(25,18,'Do you want to continue (Y/N)? ');
            Readln(Traloi)
          END
    ...
    ELSE
      BEGIN
        ...
        SayXY(37,9,White,Green,'Result');
        SetTextColor(Yellow,Magenta);
        WriteXY(28,11,'Nghi�m c�a h� ph��ng tr�nh');
        WriteXY(31,12,'* X=');
        WriteXY(31,13,'* Y=');
        GotoXY(36,12);
        Write((Dx/DD):0:2);
...
BEGIN
  REPEAT
    ...
    BigCurSor;
    Box(19,2,62,4,Brown,White,2);
    SayXY(21,3,LightCyan,Brown,'Ch��ng Tr�nh T�nh Giai Th�a C�a M�t S�');
    BoxShade(27,9,53,13,Cyan,Yellow,2);
    SayXY(34,9,White,Red,'Input Data');
    SetTextColor(Black,Cyan);
    WriteXY(29,11,'Cho giai th�a N = ');
    Readln(n);
    IF n < 0 THEN
      BEGIN
        ...
        SayXY(37,11,LightCyan+Blink,Magenta,'WARNING!');
        SetTextColor(Yellow,Magenta);
        WriteXY(29,12,'Kh�ng t�nh ���c giai th�a');
        WriteXY(32,13,'v� N l� m�t s� �m')
      END  { Of N<0 }
    ELSE
      BEGIN
        Giai_thua:=1;
...
BEGIN   { Bat dau Module_5 }
  REPEAT
    ...
    SayXY(27,3,LightCyan,Brown,'Ch��ng Tr�nh T�nh X M� Y');
    BoxShade(27,9,53,14,Cyan,Yellow,2);
    SayXY(34,9,White,Red,'Input Data');
    SetTextColor(Black,Cyan);
    WriteXY(29,11,'- Nh�p h� s� X = ');
    Readln(X);
    IF x<=0 THEN
      BEGIN
        ...
        SayXY(36,11,LightCyan+Blink,Magenta,'WARNING!');
        SetTextColor(Yellow,Magenta);
        WriteXY(28,12,'Kh�ng t�nh ���c X m� Y');
        WriteXY(35,13,'v� X <=0 ')
      END  { Of x<=0 }
    ELSE
      BEGIN
        WriteXY(29,12,'- Nh�p h� s� Y = ');
        Readln(y);
        Z:=EXP(y*LN(x));
        Clear(27,9,55,16,Blue);
...
PROCEDURE Introduce_4;
  BEGIN
    ...
    WriteXY(14,2,'Sau ��y t�i xin gi�i thi�u v�i c�c b�n c�c  ch��ng  tr�nh');
    WriteXY(10,3,'�� h�a DEMO ���c vi�t b�ng Borland Pascal Ver 7.0  trong  ch�');
    WriteXY(10,4,'�� �� h�a Text (TEXT MODE) v� ch� �� �� h�a GRAPHICS.');
    SayXY(13,6,LightGreen,Blue,'* Ch� �� TEXT :');
    SetTextColor(White,Blue);
    WriteXY(14,7,'Ch��ng tr�nh th� hi�n m�u s�c r�t phong ph� c�a ch� �� ��');
    WriteXY(10,8,'h�a trong ch� �� TEXT . Ch��ng tr�nh s� d�ng c�c k� t�  trong');
    WriteXY(10,9,'b�ng m� ASCII �� trang tr� m�n h�nh v� vi�t ch� to trong Text');
    SayXY(13,10,LightGreen,Blue,'* Ch� �� GRAPHICS_2D :');
    SetTextColor(White,Blue);
    WriteXY(14,11,'Ch��ng tr�nh s� gi�i thi�u c�ch v� h�nh trong kh�ng  gian'); ;
    WriteXY(10,12,'2  chi�u ch��ng tr�nh s� d�ng c�c thu�t to�n �� thi�t k�  c�c');
    WriteXY(10,13,'h�nh . C�c ch��ng tr�nh trong ch� �� �� h�a hai chi�u  ch� ��');
    WriteXY(10,14,'c�p ��n c�c h�nh �nh trong h� t�a �� x, y v� c�c ch��ng tr�nh');
    WriteXY(10,15,'v� h�nh trong m�t ph�ng.');
    SayXY(13,16,LightGreen,Blue,'* Ch� �� GRAPHICS_3D :');
    SetTextColor(White,Blue);
    WriteXY(14,17,'Ch��ng tr�nh s� gi�i thi�u c�ch v� h�nh trong kh�ng  gian');
    WriteXY(10,18,'3 chi�u. V� l� do h�n ch� v� th�i gian n�n t�i ch� gi�i thi�u');
    WriteXY(10,19,'v�i c�c b�n m�t ch��ng tr�nh v� h�nh trong kh�ng gian 3 chi�u');
    WriteXY(10,20,'n�y th�i , c�c ch��ng tr�nh �� h�a c�n l�i s� ���c  tr�nh b�y');
    WriteXY(10,21,'trong ph�n �� h�a c�a ph�n m�m Borland C  3.2 v� ph�n m�m n�y');
    WriteXY(10,22,'r�t h�u �ch cho vi�c thi�t k� c�c h�nh trong ch� �� ��  h�a 3');
    WriteXY(10,23,'chi�u n�n c�c b�n th�ng c�m. Ch��ng tr�nh � ph�n n�y l� m� t�');
    WriteXY(10,24,'h�nh �nh c�a m�t c�y n�m b�o b�o m� c�c b�n th��ng hay g�p.');
...
VAR Key : Char;
  BEGIN
    ...
    SayXY(34,8,White,Red,'H��ng D�n');
    SetTextColor(Black,Cyan);
    WriteXY(20,10,'Khi c�c h�p tho�i ch�y ch��ng tr�nh hi�n');
    WriteXY(20,11,'ra th� b�n ch� c�n l�m theo c�c ch�  d�n');
    WriteXY(20,12,'tr�n m�n h�nh . N�u kh�ng c� c�c ch� d�n');
    WriteXY(20,13,'th� b�n ��ng qu� lo l�ng , h�y b�nh t�nh');
    WriteXY(20,14,'g� ph�m <ENTER> l� ph� re !.');
    Readln;
    SetBorderColor(Black)
  END;
...
VAR Key : Char;
  BEGIN
    ...
    SetTextColor(Black,Cyan);
    WriteXY(14,11,'Ch��ng tr�nh Graph_Demo1,m� t� th� thu�t vi�t ch� to');
    WriteXY(14,12,'trong ch� �� v�n b�n. Ch��ng tr�nh th� hi�n kh� n�ng');
    WriteXY(14,13,'��c bi�t c�a �� h�a � ch� �� TEXT �� l� vi�c t�o  ra');
    WriteXY(14,14,'c�c d�ng ch� m�u th�t to duy chuy�n tr�n m�n h�nh.');
    ...
    SetTextColor(Black,Cyan);
    WriteXY(14,11,'Ch��ng tr�nh Graph_Demo2 l� m� t� tr�i ��t chuy�n ��ng');
    WriteXY(14,12,'xung quanh m�t tr�i. Tr�n b�u tr�i c� c�c ng�i sao l�c');
    WriteXY(14,13,'�n l�c hi�n tr�ng r�t ��p . B�n h�y l�u � ��n c�c ng�i');
    WriteXY(14,14,'sao l�n v� hi�u �ng c�a ch��ng tr�nh khi n� hi�n l�n.');
    SayXY(20,18,Yellow,Blue,'Press Any Key To Continue Or <ESC> To Quits');
    Key:=ReadKey;
    IF Key=#27 THEN Main_Menu;
    Graph_Demo2;
    ...
    SetTextColor(Black,Cyan);
    WriteXY(12,11,'Ch��ng tr�nh Graph_Demo3  l� m� t� m�t ch�m ph�o b�ng l�n');
    WriteXY(12,12,'�ang ho�t ��ng � gi�a m�n h�nh. B�n h�y ch� � v�o t�m c�a');
    WriteXY(12,13,'c�c ch�m ph�o b�ng n�y b�n s� tr�ng th�y nh�ng  h�nh  �nh');
    WriteXY(12,14,'ng�u nhi�n r�t ��p. Ngo�i ra c�n c� 4 ch�m ph�o b�ng nh�.');
    ...
    SetTextColor(Black,Cyan);
    WriteXY(12,11,'Ch��ng tr�nh Graph_Demo4 , m� t� c�ch s� d�ng hai th� t�c');
    WriteXY(12,12,'MoveTo v� LineRel . Ch��ng tr�nh v� c�c h�nh ch� nh�t d�n');
    WriteXY(12,13,'v�o t�m c�a m�n h�nh v�i m�u thay ��i ng�u nhi�n, � ch�nh');
    WriteXY(12,14,'gi�a m�n h�nh l� m�t h�nh thoi c� ��nh c� m�u bi�n ��i.');
    SayXY(20,18,Yellow,Blue,'Press Any Key To Continue Or <ESC> To Quits');
    Key:=ReadKey;
    IF Key=#27 THEN Main_Menu;
    Graph_Demo4;
    ...
    SetTextColor(Black,Cyan);
    WriteXY(12,11,'Ch��ng tr�nh Graph_Demo5, m� t� c�ch v� ���ng KOCH_GON');
    WriteXY(12,12,'l�p th�nh m�t tam gi�c ��u c� m�u thay ��i ng�u nhi�n.');
    WriteXY(12,13,'�� v� ���c h�nh n�y b�n c�n thi�t k� s�n m�t v�i  ki�u');
    WriteXY(12,14,'chu�n v� m�t s� th� t�c ti�n l�i trong h� t�a �� th�c.');
    SayXY(19,18,Yellow,Blue,'Press Any Key To Continue Or <ESC> To Quits');
    Key:=ReadKey;
    IF Key=#27 THEN Main_Menu;
    Graph_Demo5;
    ...
    SetTextColor(Black,Cyan);
    WriteXY(12,11,'Ch��ng tr�nh Graph_Demo6 , m� ph�ng m�t ��a bay �ang bay');
    WriteXY(12,12,'trong b�u tr�i v� tr� ��y sao. ��y l� ph��ng ph�p c�t v�');
    WriteXY(12,13,'d�n �� t�o h�nh �nh chuy�n ��ng,  m�t k� thu�t r�t tuy�t');
    WriteXY(12,14,'h�o trong �� h�a. D�ng th� t�c GetImage,GetMem,PutImage.');
    SayXY(19,18,Yellow,Blue,'Press Any Key To Continue Or <ESC> To Quits');
    Key:=ReadKey;
    IF Key=#27 THEN Main_Menu;
    Graph_Demo6;
    ...
    SetTextColor(Black,Cyan);
    WriteXY(12,11,'Ch��ng tr�nh Graph_Demo7 , s� d�ng c�c th� t�c BAR3D v� c�c ');
    WriteXY(12,12,'th� t�c Palette �� trang tr� m�n h�nh . Ch��ng tr�nh v� c�c');
    WriteXY(12,13,'BAR c� m�u c� ��nh, sau �� cho tham s� Color ���c thi�t l�p');
    WriteXY(12,14,'tr��c �� thay ��i m�t c�ch ng�u nhi�n cho ta tr�ng th�y ��p.');
    SayXY(20,18,Yellow,Blue,'Press Any Key To Continue Or <ESC> To Quits');
    Key:=ReadKey;
    IF Key=#27 THEN Main_Menu;
    Graph_Demo7;
    ...
    SetTextColor(Black,Cyan);
    WriteXY(12,11,'Ch��ng tr�nh Graph_Demo8 ,  ch��ng tr�nh m� t� vi�c l�m �nh');
    WriteXY(12,12,'chuy�n ��ng trong ch� �� Graphics m� kh�ng d�ng c�c th� t�c');
    WriteXY(12,13,'GetImage, GetMem,PutImage nh� th��ng l�. Th�t ra th� ch��ng');
    WriteXY(12,14,'tr�nh c�ng kh�ng c� g� gh� g�m l�m, �� l� vi�c v� c�c ���ng');
    WriteXY(12,15,'th�ng sau �� d�ng thu�t to�n che v� c�p nh�t  th��ng  xuy�n');
    WriteXY(12,16,'c�c �o�n th�ng n�y sau m�i l�n c� s� thay ��i v� tr�.');
    ...
    SetTextColor(Black,Cyan);
    WriteXY(12,11,'Ch��ng tr�nh Graph_Demo9 , ch��ng tr�nh b�n v�i c�c b�n v� k�');
    WriteXY(12,12,'thu�t �� h�a trong kh�ng gian 2 chi�u. Ch��ng tr�nh m� t� m�t');
    WriteXY(12,13,'h�nh Bolygone, gi�i thu�t c�a ch��ng tr�nh n�y l� s� d�ng c�c ');
    WriteXY(12,14,'thu�t to�n cho m�t cung c�a h�nh tr�n sau �� v� c�c cung kh�c');
    WriteXY(12,15,'n�i ti�p theo c�c cung tr��c �� .  S� cung v� ���c g�i l� b�c');
    WriteXY(12,16,'c�a Bolygone. Kho�ng c�ch gi�a c�c cung ���c g�i l� b��c t�ng.');
    SayXY(20,20,Yellow,Blue,'Press Any Key To Continue Or <ESC> To Quits');
    Key:=ReadKey;
    IF Key=#27 THEN Main_Menu;
    Graph_Demo9;
    ...
    SetTextColor(Black,Cyan);
    WriteXY(12,11,'Ch��ng tr�nh Graph_Demo10 ,  ch��ng tr�nh b�n v�i c�c b�n v�');
    WriteXY(12,12,'k� thu�t �� h�a trong kh�ng gian 2 chi�u. Ch��ng tr�nh m� t�');
    WriteXY(12,13,'m�t h�nh cu� K�nh V�n Hoa, gi�i thu�t c�a ch��ng tr�nh l� s�');
    WriteXY(12,14,'d�ng c�c �a gi�c quay xung quanh m�t �i�m c� ��nh  theo  c�c');
    WriteXY(12,15,'quy t�c sau : c�c tam gi�c ch�n s� quay c�ng  chi�u kim ��ng');
    WriteXY(12,16,'h� v� t�t c� c�c tam gi�c l� s� quay ng��c chi�u kim ��ng h�.');
    SayXY(20,20,Yellow,Blue,'Press Any Key To Continue Or <ESC> To Quits');
    Key:=ReadKey;
    IF Key=#27 THEN Main_Menu;
    Graph_Demo10;
    ...
    SetTextColor(Black,Cyan);
    WriteXY(12,11,'Ch��ng tr�nh Graph_Demo11 , ch��ng tr�nh b�n v�i c�c b�n v�');
    WriteXY(12,12,'k� thu�t �� h�a trong kh�ng gian 3 chi�u.Ch��ng tr�nh m� t�');
    WriteXY(12,13,'m�t h�nh �nh c�a c�y n�m b�o b�o m� c�c b�n th��ng th�y sau');
    WriteXY(12,14,'c�n m�a.Thu�t gi�i c�a ch��ng tr�nh n�y kh� ph�c t�p v� m�t');
    WriteXY(12,15,'to�n h�c,�� l� vi�c s� d�ng c�c ph�p chi�u trong kh�ng gian');
    WriteXY(12,16,'3 chi�u. C�n ph�i thi�t k� s�n c�c th� t�c v� ph�p chi�u.');
    SayXY(20,20,Yellow,Blue,'Press Any Key To Continue Or <ESC> To Quits');
    Key:=ReadKey;
    IF Key=#27 THEN Main_Menu;
    Graph_Demo11
...
VAR
  ...
  BEGIN
    ...
    WriteXY(18,2,'C�m �n b�n �� ch�n m�c n�y c�a ch��ng tr�nh');
    SetTextColor(Yellow,Blue);
    WriteXY(5,3,'- Ch��ng tr�nh g�m c� 6 ph�n ch�nh :');
    WriteXY(5,4,'* Ph�n I   : Gi�i Ph��ng Tr�nh B�c Nh�t c� d�ng');
    WriteXY(18,5,'A*x+B=0. V�i c�c h� s� A,B l� s� nguy�n ���c nh�p t� b�n ph�m');
    WriteXY(5,6,'* Ph�n II  : Gi�i Ph��ng Tr�nh B�c Hai c� d�ng');
    WriteXY(18,7,'A*x^2+B*x+C=0. V�i c�c h� s� A,B v� C l� c�c s� nguy�n ���c');
    WriteXY(18,8,'nh�p t� b�n ph�m.');
    WriteXY(5,9,'* Ph�n III : Gi�i H� Ph��ng Tr�nh Tuy�n T�nh c� d�ng');
    WriteXY(18,10,'A1*x+B1*y+C1=0');
    WriteXY(18,11,'A2*x+B2*y+C2=0.');
    WriteXY(18,12,'V�i c�c h� s� A1,A2,B1,B2,C1 v� C1 l� c�c s� nguy�n ���c nh�p');
    WriteXY(18,13,'t� b�n ph�m. (A1,A2,B1,B2,C1 v� C2 kh�ng ��ng th�i b�ng 0)');
    WriteXY(5,14,'* Ph�n IV  : T�nh Giai Th�a c�a N! (N<=13) v�i N l� s� nguy�n d��ng ���c ');
    WriteXY(18,15,'nh�p t� b�n ph�m.');
    WriteXY(5,16,'* Ph�n V   : T�nh X M� Y V�i X (X>0) v� Y ���c nh�p t� b�n ph�m.');
    WriteXY(5,17,'* Ph�n VI  : G�m c� c�c ch��ng tr�nh �� h�a Demontration.');
    WriteXY(28,20,'Khoa C�ng Ngh� Th�ng Tin');
    WriteXY(23,21,'Tr��ng ��i H�c K� Thu�t C�ng Ngh�');
    WriteXY(20,22,'(C) Copyright by Student Nguy�n Ng�c V�n');
    WriteXY(35,23,'L�p 00�TH01');
    WriteXY(29,19,'��y l� phi�n b�n ch�y th� nghi�m');
    WriteXY(2,18,#195);
    ...
    SayXY(31,1,White,Red,'H��ng D�n S� D�ng');
    RunChar1;
    Readln;
    ...
    ClrScr;
    Frame(2,1,79,25,1);
    WriteXY(20,6,'Tr��ng ��i H�c K� Thu�t C�ng Ngh�');
    WriteXY(25,7,'C� s� I  : 110 Cao Th�ng Qu�n 3');
    WriteXY(25,8,'C� s� II : 144/24 �i�n Bi�n Ph�');
    WriteXY(36,9,'Qu�n B�nh Th�nh');
    WriteXY(20,10,'M�i chi ti�t xin li�n h� t�i ��a ch�');
    WriteXY(25,11,'- Phone   : 9300061');
    WriteXY(25,12,'- Website : http://www.unitech.vnn.vn');
    WriteXY(25,13,'- Email   : nguyenvan@dth01.vnn.vn');
    WriteXY(20,14,'Ho�c li�n h� tr�c ti�p v�i t�c gi�');
    WriteXY(20,15,'t�i c� s� II ph�ng 403, l�u 4.');
    WriteXY(2,18,#195);
    WriteXY(78,18,#196#180);
    WriteXY(3,18,Replicate(#196,75));
    WriteXY(7,19,'Xin l�u � : Ch��ng tr�nh l� phi�n b�n ch�y th� nghi�m. C�m sao ch�p');
    WriteXY(7,20,'m�t ph�n hay c� ch��ng tr�nh d��i b�t k� h�nh th�c n�o. M�i vi ph�m');
    WriteXY(7,21,'s� b� truy t� tr��c h�i ��ng c�a nh� tr��ng. N�u c�c b�n c� nhu c�u');
    WriteXY(7,22,'v� ch��ng tr�nh ngu�n xin vui l�ng li�n h� t�i c�c ��a ch� tr�n.');
    SayXY(30,25,White,Red,'Press <ENTER> to Exit');
    SayXY(36,1,White,Red,'B�n Quy�n');
    RunChar2;
    Readln;
    NextPage;
    SetBorderColor(Black);
...
VAR
  ...
  BEGIN
    ...
    SetTextColor(Black,Cyan);
    WriteXY(17,10,'R�t c�m �n c�c b�n �� �ng h�, s� d�ng ch��ng tr�nh');
    WriteXY(17,11,'c�a t�i. Mong c�c b�n g�p � v� n�i dung c�a ch��ng');
    WriteXY(17,12,'tr�nh �� ch��ng tr�nh ���c ho�n thi�n h�n. H�n g�p');
    WriteXY(17,13,'l�i c�c b�n � ph�n l�p tr�nh chuy�n s�u ( Ph�n l�p');
    WriteXY(17,14,'tr�nh h� th�ng C/C++ v� Assembler ).');
    Readln;
    FOR i:=12 DOWNTO 0 DO
      BEGIN
