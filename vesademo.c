...
int main(int argc, const char* argv[])
{
    ...
    if (!setVesaMode(800, 600, 32, 0)) fatalError("Cannot init video mode.\n");
    ...
    if (argc > 1 && !strcmp(argv[1], "-s")) saveScreen("screen36.bmp");
    delay(3000);
    fadeCircle(2, 0);
    ...
    if (!setVesaMode(800, 600, 8, 0)) fatalError("Cannot init video mode.\n");
